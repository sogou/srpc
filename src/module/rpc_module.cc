...
bool RPCModule::client_task_begin(SubTask *task, RPCModuleData& data) const
{
...
bool RPCModule::server_task_begin(SubTask *task, RPCModuleData& data) const
{
...
bool RPCModule::client_task_end(SubTask *task, RPCModuleData& data) const
{
	SubTask *filter_task;
...
bool RPCModule::server_task_end(SubTask *task, RPCModuleData& data) const
{
	SubTask *filter_task;
